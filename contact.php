...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h2><font color="#000000">Blog </font></h2>
                <br>
                <br>
			...
			<div class="col-md-4" style="margin-top:30px">
                <h3>Contact Us</h3>
                <p>
                    E-20 Sector 63<br>Kumbalgodu, India 560058<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Phone Number </abbr>: (123) 456-7890</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email us </abbr>: <a href="mailto:name@example.com">name@example.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Available </abbr>: Monday - Sunday: 9:00 AM to 9:00 PM</p>
